...
COLORS = dict(zip(LABELS, ["#95a5a6", "#8e44ad", "#e67e22", "#16a085", "#3498db", "#e74c3c", "#2ecc71", "#c0392b", "#f1c40f"]))
...
def main() -> int:
    p = argparse.ArgumentParser(description="Render annotated TUSZ EDF previews.")
